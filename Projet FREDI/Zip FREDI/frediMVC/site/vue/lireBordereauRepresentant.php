		...
		<body>
			...
			<hr/>
			 <form name="bordereau" action="./?action=bordereauSoumisRL" method="post" id="formBordereau">
    			...
    			<table class="table" id="tabAdhrt">
    				...
    				<tr>
    				<td>
    					<input type="text" name="nomAdhrt1" id="nomAdhrt1">
    				</td>
    				<td>
    					<input type="text" name="prenomAdhrt1" id="prenomAdhrt1" >
    				</td>
    				<td>
    					<input type="text" name="licenceAdhrt1"  id="licenceAdhrt1">
    				</td>
    				<td>
    					<input type="text" name="ligue1" id="ligue1" >
    				</td>
    				</tr>
    			</tbody>
    			</table>
    			<?php
    						...
    						echo'<script type="text/javascript">';
    						echo 'addNumberOfLineAD('.$count2.')';
    						echo'</script>';

							for($j=0;$j<$count2;$j++){
    						echo'<script type="text/javascript">';
    						echo'setValueAD('.($j+1).',"'.${'nomAdhrt'.$j}.'","'.${'prenomAdhrt'.$j}.'",'.${'licenceAdhrt'.$j}.",".${'ligue'.$j}.')';
    						echo'</script>';
    					}
    			?>
				 <p class="control">
			...
			<p>
			 ...
			 <div class="control">
			  <button class="button is-primary" onclick="subRL('modif')" name="valider">Valider</button>
